...
public final class MainFragmentCrop extends Fragment
    ...
    public View onCreateView(
        ...
        Activity activity = (MainActivityCrop) getActivity();

        idNotaFiscal =  ((MainActivityCrop) activity).getIdDocumento();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            if (mDemoPreset == CropDemoPreset.SCALE_CENTER_INSIDE) {
                mCropImageView.setImageResource(R.drawable.logo_opaco);
            } else {
                mCropImageView.setImageResource(R.drawable.logo);
            }
        }
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ((MainActivityCrop) activity).setCurrentFragment(this);
    }
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        if (result.getError() == null) {
            ...
            //Colocar as variaveis aqui;
            intent.putExtra("id_documento",idNotaFiscal);

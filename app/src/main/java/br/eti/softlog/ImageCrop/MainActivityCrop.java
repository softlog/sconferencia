...
public class MainActivityCrop extends AppCompatActivity {
    ...
    private MainFragmentCrop mCurrentFragment;
    ...
    public void setCurrentFragment(MainFragmentCrop fragment) {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.main_crop, menu);
        return true;
    }
    ...
    private void setMainFragmentByPreset(CropDemoPreset demoPreset) {
        ...
        fragmentManager
                .beginTransaction()
                .replace(R.id.container, MainFragmentCrop.newInstance(demoPreset))
                .commit();
    }
